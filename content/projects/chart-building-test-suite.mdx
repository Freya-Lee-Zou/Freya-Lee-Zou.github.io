...
- **Industry-Standard Testing**: Utilized industry-standard testing frameworks such as Jest, Playwright and Cypress, the DOM Testing Library, and test doubles to ensure thorough coverage and validate critical workflows within the application
